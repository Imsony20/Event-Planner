...
const Profile = () => {
  ...
  return (
    <>
      ...
      <div className="bg-white relative mx-auto my-5 w-[25%] border p-6 rounded-lg shadow-md grid justify-around gap-5">
        <div className="w-50 h-50 rounded-full">
               <img src={userdata.photo} alt=""  className="w-50 g-50 rounded-full object-cover"/>
        </div>
